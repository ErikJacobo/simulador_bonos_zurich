...
if nombre_agente:
    ...
    if plan == "CIZ":
        if ramo == "Auto":
            ...
            datos_ingresados.append(f"Siniestralidad: {sin:.2f}%")
            ...
            if sin <= 65:
                if prod_2025 >= 100_000:
                    ...
                    porcentaje = 0.045
                    comentario = "✅ Producción entre $50,000 y $99,999 con siniestralidad aceptable. Aplica bono del 4.5%."
                elif prod_2025 >= 20_000:
                    porcentaje = 0.035
                    comentario = "✅ Producción entre $20,000 y $49,999 con siniestralidad aceptable. Aplica bono del 3.5%."
                else:
                    porcentaje = 0
...
# ✅ Esto va afuera del `if`, para que siempre se muestre
st.markdown(
